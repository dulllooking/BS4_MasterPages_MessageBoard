<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_MessageBoard.Master" AutoEventWireup="true" CodeBehind="ContentPage_Message_Reply.aspx.cs" Inherits="BS4_MasterPages_MessageBoard.ContentPage_Message_Reply" %>
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                ...
                <div class="my-1">
                    <div class="form-floating">
                        ...
                        <asp:TextBox ID="TextBox1" runat="server" class="form-control pt-1 mb-2" required="" aria-required="true" oninput="setCustomValidity('');" oninvalid="setCustomValidity('需填寫標題!')" style="height: 2rem"></asp:TextBox>
                    </div>
                    <div class="form-floating">
                        <asp:Label ID="Label4" runat="server" Text="*暱稱"></asp:Label>
                        <asp:TextBox ID="TextBox2" runat="server" class="form-control pt-1 mb-2" required="" aria-required="true" oninput="setCustomValidity('');" oninvalid="setCustomValidity('需填寫暱稱!')" style="height: 2rem"></asp:TextBox>
                    </div>
                    <div class="form-floating">
